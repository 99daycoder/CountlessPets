...
if(newQuote.pet_breed === "Akita" || newQuote.pet_breed === "Chinook" || newQuote.pet_breed === "Harrier")  {
    //10%  
    newPrice = newPrice*0.9
  }

if(newQuote.city === "London" || newQuote.city === "Manchester" || newQuote.city === "Birmingham"){
    newPrice = newPrice*1.15
}

if(newQuote.number_of_pets>=2){
    newPrice = newQuote.number_of_pets*newPrice - (basePrice*0.1*newQuote.number_of_pets)
}
return newPrice
}
